...
class Publikationen
{
    ...
    public function pubListe($param = array(), $content = '')
    {
        ...
        $michi_role = (isset($param['michi_role']) && $param['michi_role'] != '') ? $param['michi_role'] : 'author pubListe';
        echo "<script>console.log('Debug pubListe: " . $michi_role . "' );</script>";

        $pubArray = $this->fetch_publications($year, $start, $end, $type, $subtype, $fau, $peerreviewed, $notable, $language, $michi_role);
    ...
    public function pubNachJahr($param = array(), $field = '', $content = '', $fsp = false, $project = '')
    {
        ...
        $language = (isset($param['language']) && $param['language'] != '') ? $param['language'] : '';
        $sortby = (isset($param['sortby']) && $param['sortby'] != '') ? $param['sortby'] : 'virtualdate';
        $michi_role = (isset($param['michi_role']) && $param['michi_role'] != '') ? $param['michi_role'] : 'author pubNachJahr';

        echo "<script>console.log('Debug pubNachJahr: " . $michi_role . "' );</script>";

        $pubArray = $this->fetch_publications($year, $start, $end, $type, $subtype, $fau, $peerreviewed, $notable, $field, $language, $fsp, $project, $michi_role);
    ...
    public function pubNachTyp($param = array(), $field = '', $content = '', $fsp = false, $project = '')
    {
        ...
        $michi_role = (isset($param['michi_role']) && $param['michi_role'] != '') ? $param['michi_role'] : 'author pubNachTyp';

        echo "<script>console.log('Debug pubNachTyp: " . $michi_role . "' );</script>";
...
// Ende pubNachTyp()
    ...
    private function fetch_publications($year = '', $start = '', $end = '', $type = '', $subtype = '', $fau = '', $peerreviewed = '', $notable = 0, $field = '', $language = '', $fsp = false, $project = '', $michi_role = 'author')
    {
        $filter = NULL;
        ...
        try {
            ...
            if ($this->einheit === "person") {
                $pubArray = $ws->by_pers_id($this->id, $filter, $notable, $michi_role);
            }
...
class CRIS_publications extends CRIS_webservice
{
    ...
    public function by_pers_id($persID = null, &$filter = null, $notable = 0, $michi_role='by_pers_id')
    {
        # @Timon: Ich hab das mal hierhin durchgefädelt.
        echo "<script>console.log('Debug Objects no way: " . $michi_role . "' );</script>";
